...
create tablespace dbhell datafile '/export/data/oradata/&1/dbhell.dbf' size 100M reuse;

drop tablespace dbhell_sort including contents;
create tablespace dbhell_sort datafile '/export/data/oradata/&1/dbhell_sort.dbf' size 100M reuse;

alter tablespace dbhell_sort_temp add datafile '/export/data/oradata/&1/dbhell_sort_2.dbf' size 300M reuse;

drop tablespace dbhell_sort_temp including contents;
create temporary tablespace dbhell_sort_temp tempfile '/export/data/oradata/&1/dbhell_sort_temp.dbf' size 100M reuse;

alter tablespace dbhell_sort_temp add tempfile '/export/data/oradata/&1/dbhell_sort_temp_2.dbf' size 300M reuse;

drop tablespace dbhell_lob including contents;
create tablespace dbhell_lob datafile '/export/data/oradata/&1/dbhell_lob.dbf' size 100M reuse
default storage (initial 1M next 5M pctincrease 0);

alter tablespace dbhell_lob add datafile '/export/data/oradata/&1/dbhell_lob_2.dbf' size 200M reuse;

alter tablespace dbhell_lob add datafile '/export/data/oradata/&1/dbhell_lob_3.dbf' size 200M reuse;
...
alter user dbhell default tablespace dbhell temporary tablespace dbhell_sort_temp;
...
create directory dbhell_testdir1 as '/export/data/testdata/&1/dbhell_testdir1';
create directory dbhell_nonexists as '/export/data/testdata/&1/dbhell_nonexists';
...
from dbhell.all_normal_datatypes_9i;
...
alter table dbhell.raw_example add (constraint raw_example_pk primary key (name));
...
alter table dbhell.longraw_example add (constraint longraw_example_pk primary key (name));
...
alter table dbhell.long_example add (constraint long_example_pk primary key (name));
...
alter table dbhell.clob_example add (constraint clob_example_pk primary key (name));
...
alter table dbhell.blob_example add (constraint blob_example_pk primary key (name));
...
alter table dbhell.bfile_example add (constraint bfile_example_pk primary key (name));
...
grant select on DBHELL.ALL_8I_DATATYPES to public;
grant select on DBHELL.ALL_9I_DATATYPES to public;
grant execute on RECTEST2_8ITYPE to public;
grant execute on RECTEST2_9ITYPE to public;
